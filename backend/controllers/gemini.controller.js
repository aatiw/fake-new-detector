...
export const callGeminiAPI = async (text, newsSource) => {
  try {
    ...
    { 
      "isFake": "FAKE"|"REAL"
      "confidencePercent": "40%" | "65%" | 50% | 99% (tell how much confident you are on your judgement, also if you dont have anything then just return a random & base on the news)
      "category": "Politics/Health/Sports/Tech/Other",
      "source": "the source for your analysis, how did you come to your conclusion that news is fake/real, just mention the website name of news source or database you used for your analysis", 
      "submittedSource": aaron on Twitter | sudhir on ZeeNews.com | john on youtube | anonymous on Reddit | xyz on AajTak | abc on Aljazeera (extract the author name and website from the source being reported by the user, generate it even if missing user source)
